          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
            <tr *ngFor="let state of states(); let i = index" class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition">
              ...
              <td class="px-6 py-4 text-right space-x-2">
                <button (click)="openModal(state)" class="p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition">
                  <lucide-icon name="edit" class="h-4 w-4"></lucide-icon>
                </button>
                <button (click)="deleteState(state)" class="p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition">
