...
@NgModule({
    imports: [
        LucideAngularModule.pick({
            ...
            Palette, GitFork, ListChecks, Layers, CornerDownRight, AlertTriangle
        })
    ],
    exports: [
        LucideAngularModule
